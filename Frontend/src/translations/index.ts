...
export const translations: TranslationsType = {
  en: {
    ...
    // Home Page
    'home.title1': 'AI-Powered',
    'home.title2': 'Vehicle Intelligence',
    'home.subtitle': 'AutoMindAi combines blockchain security with smart AI to manage vehicle ownership, service records, and resale insights — all in one platform.',
    'home.badge': 'Powered by AutoMindAi',
    'home.getStarted': 'Get Started',
    'home.learnMore': 'Learn More',
    'home.stat1.value': '100%',
    'home.stat1.label': 'Blockchain Secured',
    'home.stat2.value': 'AI',
    'home.stat2.label': 'Smart Assistant',
    'home.stat3.value': '24/7',
    'home.stat3.label': 'Always Available',
    ...
    // Chatbot
    'chatbot.title': 'AutoMindAi Assistant',
    'chatbot.placeholder': 'Type your question here...',
    'chatbot.send': 'Send',
    'chatbot.welcome': 'Hello! I\'m your AutoMindAi assistant. How can I help you today?',
    
    // FAQ Questions
    'faq.q1': 'What is AutoMindAi?',
    ...
    'faq.q12': 'Do I need technical knowledge to use AutoMindAi?',
    'faq.q13': 'What happens during a vehicle transfer?',
    'faq.q14': 'Can I use AutoMindAi on mobile devices?',
    'faq.q15': 'Is AutoMindAi available in my country?',
    'faq.q16': 'What fees are associated with transfers?',
    'faq.q17': 'How do I get started with AutoMindAi?',
    ...
    // FAQ Answers
    'faq.a1': 'AutoMindAi is a blockchain-based platform for secure and transparent vehicle ownership management. It uses NFTs to represent vehicle titles, ensuring tamper-proof records and easy transfers.',
    ...
    'faq.a8': 'Yes, the complete history of your vehicle is accessible on the blockchain, including all previous owners, maintenance records, and transfers. You can view this history directly in the AutoMindAi application.',
    ...
    'faq.a11': 'Unlike traditional vehicle registration which relies on centralized databases and paper documents, AutoMindAi uses blockchain to create immutable, secure, and easily transferable digital ownership records that cannot be lost, damaged, or forged.',
    'faq.a12': 'No, AutoMindAi is designed to be user-friendly. You\'ll need a digital wallet like MetaMask, but the interface is intuitive and similar to other online services you\'re familiar with.',
    ...
    'faq.a14': 'Yes, AutoMindAi is fully responsive and works on smartphones, tablets, and desktop computers. You can manage your vehicle ownership from anywhere.',
    'faq.a15': 'AutoMindAi is being rolled out globally. Check our website for the most up-to-date information about availability in your country.',
    ...
    'faq.a19': 'Click on "Sign In / Sign Up", select the "Connect MetaMask" option, and follow the prompts in the MetaMask extension. Once connected, your wallet address will be associated with your AutoMindAi account.',
  ...
  hi: {
    ...
    // Home Page
    'home.title1': 'AI-संचालित',
    'home.title2': 'वाहन बुद्धिमत्ता',
    'home.subtitle': 'AutoMindAi ब्लॉकचेन सुरक्षा और स्मार्ट AI को जोड़कर वाहन स्वामित्व, सर्विस रिकॉर्ड और रीसेल insights प्रबंधित करता है।',
    'home.badge': 'AutoMindAi द्वारा संचालित',
    'home.getStarted': 'शुरू करें',
    'home.learnMore': 'और जानें',
    'home.stat1.value': '100%',
    'home.stat1.label': 'ब्लॉकचेन सुरक्षित',
    'home.stat2.value': 'AI',
    'home.stat2.label': 'स्मार्ट सहायक',
    'home.stat3.value': '24/7',
    'home.stat3.label': 'हमेशा उपलब्ध',
    ...
    // Chatbot
    'chatbot.title': 'AutoMindAi सहायक',
    'chatbot.placeholder': 'अपना प्रश्न यहां टाइप करें...',
    'chatbot.send': 'भेजें',
    'chatbot.welcome': 'नमस्ते! मैं आपका AutoMindAi सहायक हूं। मैं आज आपकी कैसे मदद कर सकता हूं?',
    
    // Some FAQ Questions in Hindi (not all for brevity)
    'faq.q1': 'AutoMindAi क्या है?',
    ...
    'faq.a1': 'AutoMindAi एक ब्लॉकचेन-आधारित प्लेटफॉर्म है जो AI के साथ सुरक्षित और पारदर्शी वाहन स्वामित्व प्रबंधन प्रदान करता है।',
 ...
 "es": {
    ...
    // Home Page
    "home.title1": "AI-ਸੰਚਾਲਿਤ",
    "home.title2": "ਵਾਹਨ ਬੁੱਧੀ",
    "home.subtitle": "AutoMindAi ਬਲਾਕਚੇਨ ਸੁਰੱਖਿਆ ਅਤੇ ਸਮਾਰਟ AI ਨੂੰ ਜੋੜ ਕੇ ਵਾਹਨ ਮਲਕੀਅਤ, ਸਰਵਿਸ ਰਿਕਾਰਡ ਅਤੇ ਰੀਸੇਲ insights ਪ੍ਰਬੰਧਿਤ ਕਰਦਾ ਹੈ।",
    "home.badge": "AutoMindAi ਦੁਆਰਾ ਸੰਚਾਲਿਤ",
    "home.getStarted": "ਸ਼ੁਰੂ ਕਰੋ",
    "home.learnMore": "ਹੋਰ ਜਾਣੋ",
    "home.stat1.value": "100%",
    "home.stat1.label": "ਬਲਾਕਚੇਨ ਸੁਰੱਖਿਅਤ",
    "home.stat2.value": "AI",
    "home.stat2.label": "ਸਮਾਰਟ ਸਹਾਇਕ",
    "home.stat3.value": "24/7",
    "home.stat3.label": "ਹਮੇਸ਼ਾ ਉਪਲਬਧ",
    ...
    // Chatbot
    "chatbot.title": "AutoMindAi ਸਹਾਇਕ",
    "chatbot.placeholder": "ਇਥੇ ਆਪਣਾ ਪ੍ਰਸ਼ਨ ਲਿਖੋ...",
    "chatbot.send": "ਭੇਜੋ",
    "chatbot.welcome": "ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਤੁਹਾਡਾ AutoMindAi ਸਹਾਇਕ ਹਾਂ। ਮੈਂ ਅੱਜ ਤੁਹਾਡੀ ਕਿਸ ਤਰ੍ਹਾਂ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ?",
    
    // Some FAQ Questions in Punjabi (not all for brevity)
    "faq.q1": "AutoMindAi ਕੀ ਹੈ?",
    ...
    "faq.a1": "AutoMindAi ਇੱਕ ਬਲਾਕਚੇਨ ਅਧਾਰਤ ਪਲੇਟਫਾਰਮ ਹੈ ਜੋ AI ਨਾਲ ਵਾਹਨ ਮਲਕੀਅਤ ਦਾ ਸੁਰੱਖਿਅਤ ਅਤੇ ਪਾਰਦਰਸ਼ੀ ਪ੍ਰਬੰਧਨ ਪ੍ਰਦਾਨ ਕਰਦਾ ਹੈ।",
